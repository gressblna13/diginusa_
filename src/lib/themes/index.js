...
const getColorsForTheme = theme => {
    ...
    // Debugging log
    console.log(`Colors for theme '${theme}':`, themeInfo.colors);

    return themeInfo.colors;
};

// Debugging logs
console.log('Available Themes:', themeMap);
console.log('Colors for Default Theme:', getColorsForTheme(DEFAULT_THEME));

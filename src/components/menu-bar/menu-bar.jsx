...
import myLogo from '../asset-panel/scratch-logo.png';
...
import nusalogo from '../asset-panel/manis.png';
...
class MenuBar extends React.Component {
    ...
    handleSetMode (mode) {
        ...
        document.getElementById('logo_img').src = catLogo; // Ganti ID yang benar
           } else if (mode === '1920') {
...
MenuBar.defaultProps = {
    logo: myLogo, // Menggunakan logo yang diimpor
    onShare: () => {}
};
